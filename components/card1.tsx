...
export default function Card1({ movie }: { movie: Movie }){
    ...
    return(
        ...
        <>
            <div className="relative w-[170px] h-[260px] md:w-[225px] md:h-[340px] rounded-xl overflow-hidden group  origin-bottom transition-transform duration-300 ease-out hover:scale-105" onClick={()=>router.push(`/discover/${movie.id}`)}>
            <Image
